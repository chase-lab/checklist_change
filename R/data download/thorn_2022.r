...
if (!file.exists("data/raw data/thorn_2022/rdata.rds")) {
   ...
   if (!file.exists("data/cache/thorn_2022_rsbl20220055_si_002.csv")) download.file(
      url = "https://rs.figshare.com/ndownloader/files/34985258",
      destfile = "data/cache/thorn_2022_rsbl20220055_si_002.csv"
   )

   dir.create("data/raw data/thorn_2022", showWarnings = FALSE)
   base::saveRDS(
      object = data.table::fread(
         file = "data/cache/thorn_2022_rsbl20220055_si_002.csv",
         header = TRUE, sep = ";"),

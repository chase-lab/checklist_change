...
env <- data.frame(
   local = c("Allegheny", "Chemung", "Susquehanna", "Delaware", "Erie-Niagara",
             "Genesee", "Lake Ontario", "Oswego", "Black", "Oswegatchie",
             "Raquette", "St. Lawrence", "St. Lawrence Canada",
             "Lake Champlain", "Upper Hudson", "Mohawk", "Lower Hudson",
             "Newark Bay", "Long Island"),

   alpha_grain = c(1920, 1740, 4520, 2390, 2280, 2373, 2460, 5070, 1920, 1590,
                   1253, (5600 - (1590 + 1253)) / 2,
                   (5600 - (1590 + 1253)) / 2, 3050, 4620, 3460, (4982 + 220),
                   211, 1650),
...
meta[, ":="(
   ...
   gamma_sum_grains = sum(1920, 1740, 4520, 2390, 2280, 2373, 2460, 5070, 1920,
                          ...
                          (5600 - (1590 + 1253)) / 2, 3050, 4620, 3460,
                          (4982 + 220), 211, 1650),
   ...
   comment = "Extracted from  D. M. CARLSON and R. A. DANIELS 'Status of Fishes in New York: Increases, Declines and Homogenization of Watersheds,' The American Midland Naturalist 152(1), 104-139, (1 July 2004). https://doi.org/10.1674/0003-0031(2004)152[0104:SOFINY]2.0.CO;2  Supplementary (table extraction, Mix of several Tabula extractions, some saved, some copy pasted because more complete than the whole document extraction). The authors aggregated freshwater fish checklists from collections and state agencies. Regional is New-York state. local are lake watersheds or river basins (sometimes, basins are truncated by state border or several small river basins are merged into one large such as around Lake Ontario cf fig1). years correspond to the end of each period (before 1940, 1940-1987, after 1987). Scientific names of fish species follow Nelson et al. (2004)",

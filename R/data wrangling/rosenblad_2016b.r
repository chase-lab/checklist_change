...
data.table::setnames(ddata, old = "Scientific name", new = "species")
...
latitudes <- parzer::parse_lat(c("7°56`S", "44°02`S", '10°25`18"S', '12°11`13"S',
                                 "21°12`S", "27°7`S", "18°10`S", "0°40`S",
                                 "13°30 N", "21° N", '31°33`15"S', "9.7812° S",
                                 "20.2°S", "0°32`S", "41°18`S", "29.03°S",
                                 "4°N", '25°04`00"S', '21°06`52"S', "19°43`S",
                                 "15°56`S", "-14.266667 N", "17°32`S", "21°08`S",
                                 "37°4`S"))
longitudes <- parzer::parse_lon(c("14°25`W", "176°26`W", '105°40`41"E',
                                  '96°49`42"E', "159°46`W", "109°22`W",
                                  "178°27`E", "90°33`W", "144°48 E", "157° W",
                                  '159°05`06"E', "139.0817° W", "57.5°E",
                                  "166°55`E", "174°47`E", "167.95°E", "160°W",
                                  '130°06`00"W', '55°31`57"E', "63°25`E",
...
meta[, ":="(
   ...
   alpha_grain = c(88, 966, 135, 14, 236.7, 163.6, 18274, 7880, 540, 16636, 14.55,
                   1049.3, 2040, 21, 268021, 34.6, sum(4, 9.55, 33.73, 388.39),
                   4.6, 2511, 108, 121, 3030, 1590, 748, 207)[match(
                      x = local,
                      table = local_names)],
   alpha_grain_unit = "km2",
   alpha_grain_type = data.table::fifelse(
      test = is.element(el = local,
                        set = c("Ascension Island", "Christmas Island",
                                "Easter Island", "Guam", "Lord Howe Island",
                                "Mauritius", "Nauru", "Norfolk Island",
                                "Pitcairn Island", "Reunion", "Rodrigues",
                                "Saint Helena")),
      yes = "island",
      no = "archipelago"),

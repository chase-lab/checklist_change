...
for (i in seq_along(mammals)) data.table::setnames(mammals[[i]], new = c("english_name", "species", unlist(mammals[[i]][1])[-(1:2)]))
...
ddata[, period_raw := c("historical+recent", "historical", "historical", "recent", "historical+recent", NA, NA, NA, NA)[match(substr(value, 1, 1), c("R", "X", "C", "I", "M", "S", "P", "V", "H"))]]
...
ddata[, ":="(
  ...
  regional = "Micronesia",
  local = c("Guam", "Palau", "Yap", "Northern Mariana Islands", "Chuuk", "Pohnpei", "Kosrae", "Marshall islands", "Wake")[match(
    local,
    c("GUAM", "PAL", "YAP", "CNMI", "CHU", "POHN", "KOSR", "MARS", "WAKE")
  )],
...
meta[, ":="(
  ...
  comment = "Extracted from Wiles, G. J. (2005). A checklist of the birds and mammals of Micronesia. MICRONESICA-AGANA-, 38(1), 141. For Mammals, the authors created the first inventory for 8 islands or groups of islands of the Micronesian Archipelago. local is an island or a group of islands.Extracted from Wiles, G. J. (2005). A checklist of the birds and mammals of Micronesia. MICRONESICA-AGANA-, 38(1), 141. Historical and recent compositions were reconstructed by considering that extinct species were only present in historical times and invasive species were only present in recent times.",

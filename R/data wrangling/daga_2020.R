...
data.table::setnames(ddata, c("species", "historical_Southeastern Mata Atlantica", "recent_Southeastern Mata Atlantica", "historical_Iguassu", "recent_Iguassu", "historical_Upper Parana", "recent_Upper Parana"))
...
ddata[, ":="(
  ...
  year = c(1900L, 2002L)[match(period, c("historical", "recent"))],
...
env[, Area..km2. := as.numeric(gsub("< ", "", Area..km2.))]
...
meta[, ":="(
  ...
  alpha_grain = env$alpha_grain[match(local, env$Ecoregion)],

...
ddata[, value := data.table::fifelse(value %in% c("â€”", "0(0.0)"), NA_character_, value)]
...
latitudes <- parzer::parse_lat(c("40.38003N", "41.16005N", "41.72943N", "41.72943N", "42.18872N"))
longitudes <- parzer::parse_lon(c("91.42204W", "91.02379W", "90.31946W", "90.31946W", "90.30899W"))

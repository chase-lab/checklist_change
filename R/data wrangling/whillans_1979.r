...
meta[, ":="(
  ...
  latitude = c('43°37`57.43"N', '43°17`20.57"N', '42°40`3.49"N')[match(local, c("Toronto Bay", "Burlington Bay", "Inner Bay"))],
  longitude = c('79°22`0.58"W', '79°48`22.97"W', '80°12`38.35"W')[match(local, c("Toronto Bay", "Burlington Bay", "Inner Bay"))],

  effort = 1L,

  alpha_grain = c(10.7, 29.1, 28)[match(local, c("Toronto Bay", "Burlington Bay", "Inner Bay"))],

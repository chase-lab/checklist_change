...
latitudes <- parzer::parse_lat(c("22°05`N", "21.4730°N", "21°08`N", "20°50`N",
                                 "20°48`N", "19.566667 N"))
longitudes <- parzer::parse_lon(c("159°30`W", "157.9868°W", "157°02`W",
                                  "156°56`W", "156°20`W", "-155.5 E"))
...
meta[, ":="(
   ...
   comment = "Checklist of bird species by RL Pyle and P Pyle, data aggregated by the authors of Chase et al 2019 (Species richness change across spatial scales).
Regional is the Hawaiian archipelago, local are islands
Full reference: Pyle, R.L., and P. Pyle. 2017. The Birds of the Hawaiian Islands: Occurrence, History, Distribution, and Status. B.P. Bishop Museum, Honolulu, HI, U.S.A. Version 2 (1 January 2017) http://hbs.bishopmuseum.org/birds/rlp-monograph",

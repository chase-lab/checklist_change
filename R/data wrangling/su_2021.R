...
data.table::setnames(basin_2456,
  old = c("Basin.Name", "Median.Longitude", "Median.Latitude", "Surface.Area", "realm"),
...
Occ_bef_2456_10682 <- data.table::melt(Occ_bef_2456_10682, id.vars = "local", variable.name = "species")
...
Occ_aft_2456_10682 <- data.table::melt(Occ_aft_2456_10682, id.vars = "local", variable.name = "species")
